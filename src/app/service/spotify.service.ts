...
export class SpotifyService {
  ...
  login() {
    ...
    const parameters = '?client_id=' + client_id + '&redirect_uri=https://damp-coast-42712.herokuapp.com/login&scope=user-read-private%20user-read-email&response_type=token&state=123';
